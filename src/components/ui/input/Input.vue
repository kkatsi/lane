...
const innerRef = useTemplateRef<HTMLInputElement>('innerRef');
defineExpose({ inputElement: innerRef });
...
<template>
  <input ref="innerRef" v-model="modelValue" data-slot="input" :class="cn(
